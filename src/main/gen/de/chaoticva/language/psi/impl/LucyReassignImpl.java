...
public class LucyReassignImpl extends ASTWrapperPsiElement implements LucyReassign {

  public LucyReassignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LucyVisitor visitor) {
    visitor.visitReassign(this);
  }
